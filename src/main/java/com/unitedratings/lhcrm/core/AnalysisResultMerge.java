...
public class AnalysisResultMerge implements Callable<PortfolioStatisticalResult> {
    ...
    private void saveAnalysisResult(PortfolioStatisticalResult statisticalResult) {
     ...
     * @throws IOException
     */
    private AssetPoolInfo prepareAssetPoolInfo() throws InvalidFormatException, IOException {
        //查询封装资产池信息
